...
public class ThresholdV5Panel extends JPanel implements PropertyChangeListener {
	...
	private WeakReference<BuildSpotsMeasuresV5> processorRef = null;
	...
	private BuildSpotsMeasuresV5 getProcessor() {
	...
	private void setProcessor(BuildSpotsMeasuresV5 processor) {
	...
	void startDetection() {
		Experiment exp = (Experiment) parent0.expListComboLazy.getSelectedItem();
		if (exp != null) {
			BuildSpotsMeasuresV5 processor = new BuildSpotsMeasuresV5();
	...
	private void stopDetection() {
		BuildSpotsMeasuresV5 processor = getProcessor();
