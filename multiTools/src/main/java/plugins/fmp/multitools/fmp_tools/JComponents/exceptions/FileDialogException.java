package plugins.fmp.multitools.fmp_tools.JComponents.exceptions;

/**
 * Exception thrown when file dialog operations fail. This includes file
 * selection, validation, and I/O errors.
 */
