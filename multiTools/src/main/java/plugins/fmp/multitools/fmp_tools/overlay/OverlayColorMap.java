...
/**
 * Color map overlay that creates a transparent background with colored mask
 * areas. This implementation uses a fully transparent background (alpha =
 * 0x00000000).
 * 
 * <p>
 * The color map is designed for overlay visualization where only specific areas
 * (mask positions) should be visible while the background remains transparent.
 * </p>
 * 
 * @author MultiSPOTS96
 */
