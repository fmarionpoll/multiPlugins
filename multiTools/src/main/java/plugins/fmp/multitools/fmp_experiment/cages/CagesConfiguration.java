...
public final class CagesConfiguration {
	...
	public int getNTotalCages() {
		return nCagesAlongX * nCagesAlongY;
	}
	...
	public int getDetectNFrames() {
		return detectNFrames;
	}

	public boolean isEnableThreadSafety() {
		return enableThreadSafety;
	}
	...
	public boolean isValidConfiguration() {
		return nCagesAlongX > 0 && nCagesAlongY > 0 && nColumnsPerCage > 0 && nRowsPerCage > 0 && detectBinMs > 0;
	}
