...
public enum EnumResults {
	...
	TOPRAW00("topraw00", "volume (ul)", "top liquid level (t-t00)", StoredDataAccessors.accessStored_TOPRAW00(),
			"TOPRAW00", PersistenceDomain.CAPILLARY),
	TOPLEVEL00("toplevel00", "volume (ul)", "top liquid compensated for evaporation (t-t00)",
			StoredDataAccessors.accessStored_TOPLEVEL00(), "TOPLEVEL00", PersistenceDomain.CAPILLARY),
	TOPRAW_AND_00("topraw+00", "volume (ul)", "topraw (solid) and topraw00 (dashed)",
			StoredDataAccessors.accessStored_TOPRAW(), "TOPRAW_AND_00", PersistenceDomain.CAPILLARY),
	TOPLEVEL_AND_00("toplevel+00", "volume (ul)", "toplevel (solid) and toplevel00 (dashed)",
			StoredDataAccessors.accessStored_TOPLEVEL(), "TOPLEVEL_AND_00", PersistenceDomain.CAPILLARY),
