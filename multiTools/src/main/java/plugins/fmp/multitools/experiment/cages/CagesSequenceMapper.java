...
/**
 * Handles transfer of cage data between the logical experiment model and
 * sequences.
 * 
 * <p>
 * This mapper provides operations for:
 * <ul>
 * <li>Transferring cage ROIs to/from {@link SequenceCamData} (camera data
 * sequence)</li>
 * <li>Synchronizing cage geometry before persistence operations</li>
 * </ul>
 * 
 * <p>
 * This class follows the same pattern as {@code SpotsSequenceMapper} and
...
public final class CagesSequenceMapper {
	 ...
	 * This operation:
	 * <ol>
	 * <li>Removes all existing ROIs with names containing "cage" from the
	 * sequence</li>
...
//	}
	...
	/**
	 * @deprecated Use {@link #transferROIsFromSequence(Cages, SequenceCamData)}
	 *             instead.
	 */
	@Deprecated
