...
public class FlyDetect1 extends FlyDetect {
	...
	protected void findFliesInAllFrames(Experiment exp) {
		...
		for (int index = 0; index < totalFrames; index++) {
			...
			updateFlyDetectBackgroundOptions(exp, t, t_previous, bgOpts);
	...
	private void updateFlyDetectBackgroundOptions(Experiment exp, int t, int t_previous,
			CanvasImageTransformOptions bgOpts) {
		SequenceLoaderService loader = new SequenceLoaderService();
