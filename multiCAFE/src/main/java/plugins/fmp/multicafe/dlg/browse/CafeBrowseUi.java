...
final class CafeBrowseUi {

	private CafeBrowseUi() {
	}
	...
	static JPanel createNavigationPanel(MultiCAFE parent0, JButton previousButton, JButton nextButton) {
	...
	static JPanel createButtonPanel(JButton openButton, JButton createButton, JButton searchButton, JButton closeButton,
			JToggleButton showFilterButton, JToggleButton showEditButton, JToggleButton showFindButton) {
