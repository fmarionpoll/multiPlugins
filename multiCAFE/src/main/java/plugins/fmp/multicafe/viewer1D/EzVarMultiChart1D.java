...
public class EzVarMultiChart1D extends EzVar<XYSeriesCollection> {
	 ...
	 */
	private EzVarMultiChart1D(String varName, XYSeriesCollection[] defaultValues, int defaultValueIndex,
			boolean allowUserInput) throws NullPointerException {
		super(new VarMultiLineChart(varName, defaultValues == null ? null : defaultValues[defaultValueIndex]),
