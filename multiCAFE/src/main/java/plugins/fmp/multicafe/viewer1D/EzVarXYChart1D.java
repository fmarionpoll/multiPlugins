...
public class EzVarXYChart1D extends EzVar<double[][]> {
	 ...
	 */
	private EzVarXYChart1D(String varName, double[][][] defaultValues, int defaultValueIndex, boolean allowUserInput)
			throws NullPointerException {
		super(new VarXYChart(varName, defaultValues == null ? null : defaultValues[defaultValueIndex]), defaultValues,
